...
import { Inventory, STOCK_OUT, stockOutSchema } from "../schema";
...
export function StockOut({ inventory, onClose }: StockOutProps) {
  const form = useForm<stockOutSchema>({
    resolver: zodResolver(STOCK_OUT),
    defaultValues: {
      quantity: 1,
      notes: "",
    },
