...
export function CreateMinPurchaseDiscount() {
  ...
  const form = useForm<createMinPurchaseInput, any, createMinPurchaseOutput>({
    ...
    defaultValues: { storeId: "", valueType: "PERCENTAGE", value: 0, minPurchaseAmount: 0 },
  });
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[520px] rounded-3xl p-6 border-green-200">
        <DialogHeader className="space-y-2">
          <DialogTitle className="text-3xl font-bold tracking-tight">Create discount</DialogTitle>
          <p className="text-muted-foreground text-sm">Add a minimum purchase discount</p>
        </DialogHeader>
        <form onSubmit={form.handleSubmit(onSubmitButton)} className="space-y-5 pt-2">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => form.setValue("valueType", value as createMinPurchaseOutput["valueType"])}
            >
              <SelectTrigger className="w-full h-12 rounded-2xl">
          ...
          <div className="space-y-2">
            ...
            {form.formState.errors.minPurchaseAmount && (
              <p className="text-destructive text-xs">{form.formState.errors.minPurchaseAmount.message}</p>
            )}
          </div>
          <div className="space-y-2">
