import z from "zod";
import { VOUCHER_SORT_BY, VOUCHER_SORT_ORDER, VOUCHER_USAGE_TYPE, VOUCHER_VALUE_TYPE } from "./constant";
...
export const CREATE_VOUCHER = z
  ...
  .refine((data) => (data.usageType === "PRODUCT_SPECIFIC" ? data.productId !== undefined : true), {
