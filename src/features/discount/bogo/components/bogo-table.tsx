        ...
        <TableBody>
          {bogos.map((bogo) => (
            <TableRow key={bogo.id}>
              ...
              <TableCell>
                <span
                  className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${bogo.isActive ? "bg-green-100 text-green-700" : "bg-stone-100 text-stone-500"}`}
                >
              ...
              <TableCell className="text-right">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem onClick={() => onEdit(bogo)}>
                      <Pencil className="size-4" />
                      Edit
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => onDelete(bogo)}>
