 ...
 * ((customer)/(shop)/profile) dan admin (admin/profile). Sengaja tidak
 * mengandung layout/navbar apapun — pembungkusnya (SiteHeader/AdminSidebar)
 * sudah beda otomatis lewat layout.tsx masing-masing route group.
 */
